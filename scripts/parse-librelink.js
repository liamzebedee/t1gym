// Parse LibreLink CSV.
// Usage: 
//   TZ=Australia/Brisbane node scripts/parse-librelink.js > data/libreview-parsed.json
// 

const fs = require('fs')
const path = require('path')

const csv = fs.readFileSync(path.join(__dirname, '/../data/LiamZ_glucose_7-23-2020.csv'), { encoding: 'utf-8'})
