...
// Usage: 
//   NIGHTSCOUT_ENDPOINT_URL="" NIGHTSCOUT_API_TOKEN="" node ./scripts/librelink2nightscout.js
// 

// const [from,to] = [1595340000000, 1595426400000]
const DAY = 60*1000*60*24
const [from,to] = [1595426400000-3*DAY, 1595340000000*2 ]
