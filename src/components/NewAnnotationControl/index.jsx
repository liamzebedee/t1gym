...
export const NewAnnotationControl = ({
  startTime,
  endTime,
  onSave,
  onDiscard,
    ...
    <div>
      <Stack shouldWrapChildren>
        <Flex flexDirection="row">
          ...
          <span>
            <b>BGL</b>
            <br /> {(stats.startBG || 0).toFixed(1)}mmol
          </span>
        </Flex>
        ...
        <Flex flexDirection="row">
          ...
          <span style={{ width: 150 }}>
            <b>BGL</b>
            <br /> {(stats.endBG || 0).toFixed(1)}mmol
          </span>
          <Box paddingRight="5"></Box>
          <span style={{ width: 150 }}>
            <b>Δ BGL</b>
            <br /> {(stats.deltaBG || 0) > 0 ? "+" : ""}
        ...
        <Flex flexDirection="row">
          <span style={{ width: 150 }}>
            ...
            <span className={styles.carbs}>
              {(stats.totalCarbs || 0).toFixed(0)}g
            </span>
          </span>
          <Box paddingRight="5"></Box>
          <span style={{ width: 150 }}>
            <b>Total insulin</b>:{" "}
            <span className={styles.insulin}>
              {(stats.totalInsulin || 0).toFixed(1)}U
            </span>
          </span>
        </Flex>
        ...
        <Stack isInline>
          <Button size="sm" variantColor="green" onClick={onClickSave}>
            Save
          </Button>
          <Button size="sm" variantColor="gray" onClick={onClickDiscard}>
            Discard
          </Button>
        </Stack>
      </Stack>
